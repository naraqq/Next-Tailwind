...
function Header() {
  ...
  return (
    <div className="h-20 bg-fuchsia-900 flex justify-center">
      <div className="w-11/12 flex justify-between lg:w-10/12">
        ...
        <div className="h-20 lg:flex w-1/3 items-center justify-between hidden">
          <div class="group inline-block relative">
            <button class=" py-2 px-4 rounded inline-flex items-center">
              <Link href="/Product" replace>
                <a className="text-white text-sm font-medium">Product</a>
              </Link>
              <svg
                className="h-4 w-4"
                fill="white"
          ...
          <Link href="/Solutions">
            <a className="text-white text-sm font-medium">Solutions</a>
          </Link>
          <Link href="/Enterprise">
            <a className="text-white text-sm font-medium">Enterprise</a>
          </Link>
          <Link href="/Sources">
            <a className="text-white text-sm font-medium">Sources</a>
          </Link>
          <Link href="/Pricing">
            <a className="text-white text-sm font-medium">Pricing</a>
          </Link>
        </div>
        ...
        <div className="flex gap-5">
          ...
          <div
            onClick={sideBar}
            className="h-20 flex items-center mr-5 lg:hidden"
          >
          ...
          <div className="text-white text-base font-medium h-20 lg:flex items-center mr-5 hidden">
            Sign in
          </div>
          ...
          <div className="lg:flex items-center hidden">
            <button className="h-10 bg-white rounded py-2 px-3 font-medium text-sm text-fuchsia-900 ml-2 ">
              TRY FOR FREE
            </button>
          </div>
        </div>
        ...
        >
          <div className="flex justify-between flex-column">
            ...
            <div className="p-2" onClick={sideBar}>
              <svg
                width="18"
                height="18"
                viewBox="0 0 13 13"
